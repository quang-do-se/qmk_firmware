...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT(
		KC_GRAVE       , KC_F1  , KC_F2  , KC_F3,  KC_F4,   KC_F5 ,  KC_F6,   KC_F7,   KC_F8  , KC_F9  , KC_F10 , QT_F11 , QT_F12 ,          KC_RGUI ,
    ...
    [_FUNCTION] = LAYOUT(
		...
		_______      , _______, _______,                    _______,                            _______, QT_FN  ,          _______, KC_END , _______
    ),
	[_RGB] = LAYOUT(
		_______      , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
