...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT(
		KC_GRAVE       , KC_F1  , KC_F2  , KC_F3,  KC_F4,   KC_F5 ,  KC_F6,   KC_F7,   KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 ,          QT_RGUI ,
		QK_GRAVE_ESCAPE, KC_1   , KC_2   , KC_3 ,  KC_4 ,   KC_5  ,  KC_6 ,   KC_7 ,   KC_8   , KC_9   , KC_0   , KC_MINS, KC_EQL , KC_BSPC, KC_GRAVE,
    ...
    [_FUNCTION] = LAYOUT(
		...
		_______      , _______, _______, _______ , _______, _______, _______, KC_MUTE, _______, _______, _______, _______,          KC_HOME,
		_______      , _______, _______,                    KC_MEDIA_PLAY_PAUSE,                _______, QT_FN  ,          _______, KC_END , _______
    ),
    [_SWITCH] = LAYOUT(
