...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNCTION] = LAYOUT_60_ansi(
                                 ...
                                 _______,  _______,  _______,                      KC_MEDIA_PLAY_PAUSE,                    KC_LEFT,  KC_DOWN,  KC_RGHT,            QD_SWITCH
                                 ),
    ...
    [_RGB] = LAYOUT_60_ansi(
                            ...
                            _______,  _______,  _______,                      _______,                                _______,  _______,  _______,            QD_SWITCH
                            ),

    [_SWITCH] = LAYOUT_60_ansi(
                               QD_BASE,  QD_FUNCTION, QD_RGB ,  _______, _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  QK_BOOT,
                               _______,  _______    , _______,  _______,          _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
                               _______,  _______    , _______,  _______,          _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
