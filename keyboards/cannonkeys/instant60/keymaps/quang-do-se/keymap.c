...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SWITCH] = LAYOUT_60_ansi(
                               QD_BASE,  QD_FUNCTION, QD_RGB,   QD_ENTERTAINMENT, _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
                               ...
                               QK_BOOT,  _______,     _______,                              _______,                                _______,  _______,  _______,            TD(TD_FUNCTION_SWITCH)
                               ),
};
